...
class TestBaseConverter:
    ...
    def test_is_valid_number(self):
        ...
        assert self.converter.is_valid_number("G", 16) == False # Invalid digit for base
    ...
    def test_format_number_with_separators(self):
        ...
        assert self.converter.format_number_with_separators("11111111", 2) == "1111_1111"
        assert self.converter.format_number_with_separators("123456789", 10) == "1_2345_6789"
        
        # Custom separator and group size
        assert self.converter.format_number_with_separators("11111111", 2, "-", 2) == "11-11-11-11"
    ...
    def test_detect_base(self):
        ...
        assert self.converter.detect_base("123") == 10  # Could be many bases, but 10 is most common
...
class TestIntegration:
        ...
        for i, number in enumerate(test_numbers):
            ...
            for target_base in [2, 8, 10, 16, 36]:
                if source_base != target_base:
                    ...
                    back_converted = converter.convert_base(converted, target_base, source_base)
    ...
    def test_arithmetic_consistency(self):
        ...
        decimal_result = converter.binary_arithmetic(
            converter.decimal_to_base(5, 2), 
            converter.decimal_to_base(3, 2), 
            "+"
        )
