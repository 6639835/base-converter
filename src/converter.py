...
class BaseConverter:
    ...
    def format_number_with_separators(self, number: str, base: int, separator: str = "_", group_size: int = 4) -> str:
        """
    ...
    def validate_conversion(self, original: str, converted: str, source_base: int, target_base: int) -> bool:
        """
